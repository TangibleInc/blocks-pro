...
Extend Tangible Blocks with Pro features: third-party plugin integrations - Easy Digital Downloads, Events Calendar, Gravity Forms, LearnDash, LifterLMS, WooCommerce.

Repository: https://github.com/tangibleinc/blocks-pro
...
```sh
git clone git@github.com:tangibleinc/blocks-pro.git
cd blocks-pro
npm install
```
